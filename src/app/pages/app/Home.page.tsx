...
const RENDERED_DEMO = [
  ...
  {
    type: "ul",
    items: ["Live preview", "Syntax highlighting", "Export to PDF"],
  },
  { type: "blockquote", content: "Beautiful markdown, instantly." },
  {
    type: "codeblock",
    lang: "js",
    content: `const md = new WriteMarkdown();\nmd.render("# Hello");`,
  },
];
      ...
      {RENDERED_DEMO.map((block, i) => {
        if (block.type === "h1")
          return (
            <h1
              key={i}
              className="text-xl font-bold text-neutral-900 dark:text-white font-sans tracking-tight"
            >
        ...
        if (block.type === "h2")
          return (
            <h2
              key={i}
              className="text-base font-semibold text-neutral-900 dark:text-white font-sans tracking-tight mt-4 pt-3 border-t border-neutral-200 dark:border-neutral-700"
            >
              {block.content as string}
            </h2>
          );
            ...
            <p key={i} className="text-neutral-700 dark:text-neutral-300">
              {(block.content as any[]).map((c, j) =>
                typeof c === "string" ? (
                  ...
                  <code
                    key={j}
                    className="px-1.5 py-0.5 rounded bg-neutral-100 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-200 font-mono text-[11.5px]"
                  >
                    {c.code}
                  </code>
                ) : null,
        ...
        if (block.type === "blockquote")
          return (
            <blockquote
              key={i}
              className="border-l-2 border-neutral-300 dark:border-neutral-600 pl-3 text-neutral-500 dark:text-neutral-400 italic"
            >
              {block.content as string}
            </blockquote>
          );
        if (block.type === "codeblock")
          return (
            <div
              key={i}
              className="rounded-lg bg-neutral-900 dark:bg-neutral-950 p-3 mt-2"
            >
              ...
              <pre className="font-mono text-[11px] text-neutral-300 leading-relaxed whitespace-pre">
                {block.content as string}
              </pre>
            </div>
          );
...
export default function HomePage() {
  ...
  return (
    <main className="bg-white dark:bg-neutral-950 text-neutral-900 dark:text-white overflow-x-hidden">
      ...
      <section
        ref={heroRef}
        className="relative min-h-[90vh] flex flex-col items-center justify-center px-5 pt-16 pb-24 overflow-hidden"
      >
        ...
        >
          ...
          >
            One ecosystem — an NPM package for React apps, a VS Code extension
            for raw file preview, and a full web editor with live preview,
            export, and sharing.
          </motion.p>
          ...
          >
            <motion.button
              whileTap={{ scale: 0.97 }}
              onClick={() => router.push("/")}
              className="flex items-center gap-2 px-6 py-3 rounded-xl bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 font-semibold text-sm dark:shadow-white/5 hover:bg-neutral-700 dark:hover:bg-neutral-100 transition-colors"
            >
              Open Editor <ArrowRight className="w-4 h-4" />
            </motion.button>
            <motion.div
              className="flex items-center gap-2 px-3 py-3 rounded-lg bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 font-mono text-sm text-gray-700 dark:text-neutral-300"
            >
        ...
        >
          <div className="flex items-center gap-2 px-4 py-3 bg-neutral-100 dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800">
            ...
            <span className="flex-1 mx-3 text-center text-xs text-neutral-400 font-medium">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-0 md:divide-x divide-neutral-200 dark:divide-neutral-800">
            {STATS.map((s, i) => (
              ...
              >
                ...
                <span className="text-xs text-neutral-500 dark:text-neutral-500 mt-1 font-medium">
                  {s.label}
                </span>
              </FadeIn>
            ))}
      ...
      <section className="py-24 px-5 sm:px-8">
        <div className="max-w-5xl mx-auto">
          <FadeUp className="text-center mb-16">
            ...
            <h2
              className="text-[clamp(1.8rem,4vw,2.8rem)] font-bold tracking-[-0.025em] text-neutral-900 dark:text-white"
              style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
            >
            ...
            <p className="mt-4 text-neutral-500 dark:text-neutral-400 max-w-lg mx-auto text-[15px] leading-relaxed">
              From quick notes to full documentation — Write Markdown has every
              feature to make your workflow seamless.
            </p>
          </FadeUp>
            ...
            {FEATURES.map((f, i) => (
              <FadeUp key={i} delay={i * 0.07}>
                ...
                >
                  ...
                  <h3 className="text-[14.5px] font-semibold text-neutral-900 dark:text-white mb-2 tracking-tight">
                    {f.title}
                  </h3>
      ...
      <section className="py-24 px-5 sm:px-8 bg-neutral-50/60 dark:bg-neutral-900/20 border-y border-neutral-100 dark:border-neutral-800/50">
        <div className="max-w-5xl mx-auto">
          <FadeUp className="text-center mb-14">
            ...
            <p className="mt-4 text-neutral-500 dark:text-neutral-400 max-w-lg mx-auto text-[15px] leading-relaxed">
              One unified markdown ecosystem — in your browser, your React app,
              or VS Code.
            </p>
          </FadeUp>
                ...
                >
                  <div className="flex flex-col justify-center py-4">
                    <div className="flex items-center gap-2 mb-5">
                      ...
                      <div>
                        <span className="text-[10.5px] font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500">
                          {product.tag}
                        </span>
                        <div className="flex items-center gap-2">
                          <span className="text-[11px] font-medium text-emerald-500 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200/60 dark:border-emerald-800/40 px-2 py-0.5 rounded-full">
                            {product.badge}
                          </span>
                        </div>
                      </div>
                    ...
                    <h3
                      className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-white mb-3"
                      style={{
            ...
            {[
              {
                ...
                desc: "Install the NPM package, grab the VS Code extension from the marketplace, or open the web editor in your browser.",
              },
              {
                step: "02",
                icon: <FileText className="w-4 h-4" />,
                title: "Write Markdown",
                desc: "Start typing your markdown with full syntax support — headings, tables, code blocks, and more.",
              },
              {
                step: "03",
                icon: <Share2 className="w-4 h-4" />,
                title: "Export & Share",
                desc: "Download as .md, export as PDF, or generate a shareable link. Your content, delivered anywhere.",
              },
            ].map((step, i) => (
              <FadeUp key={i} delay={i * 0.12}>
                <div className="flex flex-col items-center text-center p-6 relative">
                  ...
                  <span className="text-[11px] font-bold text-neutral-300 dark:text-neutral-700 mb-2 tracking-widest font-mono">
                    {step.step}
                  </span>
                  <h3 className="text-[15px] font-semibold text-neutral-900 dark:text-white mb-2 tracking-tight">
                    {step.title}
                  </h3>
                  <p className="text-[13.5px] text-neutral-500 dark:text-neutral-400 leading-relaxed">
                    {step.desc}
      ...
      <section className="py-20 px-5 sm:px-8 bg-neutral-50/60 dark:bg-neutral-900/20 border-y border-neutral-100 dark:border-neutral-800/50">
        <div className="max-w-5xl mx-auto">
          <FadeUp className="text-center mb-12">
            ...
            <h2
              className="text-[clamp(1.6rem,3.5vw,2.4rem)] font-bold tracking-[-0.025em] text-neutral-900 dark:text-white"
              style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
            >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              {
                quote:
                  "Write Markdown is the cleanest markdown tool I've used. The live preview is buttery smooth and the VS Code extension is a must-have.",
                name: "Sarah K.",
                role: "Frontend Developer",
              },
              {
                quote:
                  "Dropped the NPM package into our docs site in 5 minutes. Tiny bundle, perfect output. Zero config needed.",
                name: "Marcus T.",
                role: "Full-stack Engineer",
              },
              {
                quote:
                  "I write all my READMEs in the web editor now. The sharing feature alone saves me so much time.",
                name: "Priya M.",
                  ...
                  <div className="flex gap-0.5">
                    {Array(5)
                      ...
                      .map((_, j) => (
                        <Star
                          key={j}
                          className="w-3.5 h-3.5 fill-neutral-900 dark:fill-white text-neutral-900 dark:text-white"
                        />
                      ))}
                  </div>
                  <p className="text-[13.5px] text-neutral-600 dark:text-neutral-400 leading-relaxed flex-1">
                    "{t.quote}"
                  </p>
      ...
      <section className="py-28 px-5 sm:px-8 relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <FadeUp>
            ...
            <h2
              className="text-[clamp(2rem,5vw,3.2rem)] font-bold tracking-[-0.03em] text-neutral-900 dark:text-white mb-4"
              style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
            >
              Start writing better markdown today
            </h2>
            <p className="text-[15px] text-neutral-500 dark:text-neutral-400 mb-10 leading-relaxed">
              Free forever. No sign-up required. Open the editor and start
              writing in seconds.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                onClick={() => router.push("/")}
                className="flex items-center gap-2 px-7 py-3.5 rounded-xl bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 font-semibold text-sm dark:shadow-white/5 hover:bg-neutral-700 dark:hover:bg-neutral-100 transition-colors w-full sm:w-auto justify-center"
              >
